...
namespace gz
{
  ...
  namespace sensors
  {
    ...
    inline namespace GZ_SENSORS_VERSION_NAMESPACE
    {
      ...
      class GpuLidarWithScanningPatternSensor;
      ...
      /// \def GpuLidarWithScanningPatternSensorPtr
      /// \brief Shared pointer to GpuLidarSensor
      typedef std::shared_ptr<GpuLidarWithScanningPatternSensor> GpuLidarWithScanningPatternSensorPtr;
